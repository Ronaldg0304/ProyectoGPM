    ...
    <body>
        <div class="container-fluid bg-white">
                    ...
                    <div class="table-responsive  ">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="ServletSolicitudes?accion=read&idSolicitud=<%= solicitud.getIdSolicitud()%>" class="m-2"><img src="icon/clarity--edit-solid.png" style="width: 22px"/></a>

                                        <a href="ServletSolicitudes?accion=delete&idSolicitud=<%= solicitud.getIdSolicitud()%>" class="m-2" ><img src="icon/mdi--delete.png" style="width: 24px"/></a>
                                    </td>
            ...
            <div class="row col-md-8 offset-md-2 mt-4">
                <footer class="text-secondary pt-4 mt-4 text-center fs-p-index">
                    <p>GMP.net - Todos los derechos reservados &copy; 2024</p>
                </footer>
            </div>
        </div>
